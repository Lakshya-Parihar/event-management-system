  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost/EMS/backend/User/contact.php",
        form
      );
      if (res.data.success) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      >
        ...
        <div className="space-x-4 ml-36 font-semibold text-white flex">
          <Link
            to="/"
      ...
      <div className="min-h-screen bg-white flex flex-col items-center justify-start relative overflow-hidden mb-5">
        {/* Solid Blue Background */}
        <div className="absolute top-0 left-0 w-full h-64 bg-blue-500 z-0" />

        {/* Animated Cursor Tracker */}
        <motion.div
          className="fixed top-0 left-0 w-10 h-10 border-2 border-black rounded-full flex items-center justify-center pointer-events-none z-[9999]"
        ...
        <motion.div
          ...
          className="z-10 w-full text-center py-16"
        >
        ...
        <motion.div
          ...
          className="z-10 bg-white shadow-2xl rounded-xl p-8 w-full max-w-md"
        >
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="bg-blue-600 text-white w-full py-2 rounded-md font-semibold transition-all"
            >
              Send a message
            </motion.button>
          </form>
        ...
        <motion.div
          ...
          className="z-10 mt-16 mb-1 text-center text-lg text-gray-600"
        >
          ...
          <div className="mt-4">
            <p>📍 V ,SilverOak Uni 24, GOTA - 400072</p>
            <p>📧 contact@example.com</p>
            <p>📞 9820039060 / 9820039162</p>
          </div>
