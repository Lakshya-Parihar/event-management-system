...
import Image1 from "../Images/pricing-img-1.jpg";
import Image2 from "../Images/pricing-img-2.jpg";
import Image3 from "../Images/pricing-img-3.jpg";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      >
        ...
        <div className="space-x-4 ml-36 text-center flex font-semibold text-white">
          <Link
            to="/"
        ...
        <div className="flex items-center gap-2">
          <Link to="/login">
            <button className="px-4 py-2 bg-white text-blue-600 rounded-xl font-semibold shadow hover:scale-105 transition">
              LOGIN
            </button>
          </Link>
          <Link to="/register">
      ...
      <section className="relative text-center py-16 px-6">
        <div className="backdrop-blur-lg bg-blue-100/60 rounded-3xl max-w-5xl mx-auto p-10 shadow-xl border border-blue-200">
          <motion.h1
            className="text-3xl sm:text-4xl font-bold text-[#252b48]"
            variants={fadeInUp}
            initial="hidden"
            animate="visible"
          >
            PUBLISH EVENTS FOR <span className="text-[#fe5b3d]">FREE</span> ON{" "}
            <br /> THE WORLD'S LARGEST EVENTS MARKETPLACE
          </motion.h1>

          <motion.p
            className="mt-4 text-[#5f6c7b]"
            variants={fadeInUp}
            initial="hidden"
            animate="visible"
          >
            Our pricing is simple—publish your events for free, and attendees
            pay low cost Ticketing Fees only on paid tickets.
          </motion.p>

          <a href={"/login"}>
            <motion.button
              className="mt-6 px-6 py-2 rotating-gradient text-white rounded-full"
              variants={fadeInUp}
              initial="hidden"
              animate="visible"
            >
        ...
        >
          <motion.h2
            className="text-xl font-bold mb-2 text-[#252b48]"
            variants={fadeInUp}
          >
            YOUR #1 PARTNER IN EVENT SUCCESS
          </motion.h2>
          <motion.p className="text-[#5f6c7b] mb-12" variants={fadeInUp}>
            We put event management on auto-pilot, so you can focus on creating
            ...
            {[
              {
                ...
                img: Image1,
                description:
                  "Powerful discovery tools connect local ticket-buyers to your events. Promote directly from our built-in marketing suite.",
                points: [
              ...
              {
                title: "Fast-track ticket sales",
                img: Image2,
                description:
                  "Get paid fast with best-in-class checkout and payment processing.",
                points: [
                  "Custom pages and ticket types",
                  "All event creation",
              ...
              },
              {
                ...
                img: Image3,
                description:
                  "Automate check-in and reminders. Engage attendees before, during, and after the event.",
                points: [
          ...
          <a href={"/"}>
            <motion.div className="mt-12 text-center" variants={fadeInUp}>
              <button className="px-6 py-2 border border-[#474fa0] text-[#474fa0] rounded-full hover:bg-[#fe5b3d] hover:text-white transition">
                Learn more about our features
              </button>
              <p className="text-xs text-gray-400 mt-2">
                *Eventbrite Ads only available in select markets. Ad spend not
                included.
              </p>
            </motion.div>
          </a>
