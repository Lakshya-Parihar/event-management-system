  ...
  const handleDeleteOrg = async (orgId) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost/EMS/backend/Admin/delete_orgs.php",
        { id: orgId }
      );
      if (res.data.success) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        ...
        <h1 className="text-3xl font-bold mb-6 text-center">MANAGE ORGANIZERS</h1>
        
        {orgs.length === 0 ? (
          <p className="text-gray-500 text-center font-bold uppercase mt-20">No Organizers found.</p>
        ) : (
          <>
                ...
                <tbody>
                  {orgs.map((org, index) => (
                    ...
                    >
                      ...
                      <td className="p-4">{org.city}</td>
                      <td className="p-4">{org.state}</td>
                      <td className="p-4">
                        <motion.button
                ...
                >
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 gap-4 text-sm">
                      ...
                      <div>
                        <strong>City:</strong> {selectedOrg.city}
                      </div>
                      <div>
                        <strong>State:</strong> {selectedOrg.state}
                      </div>
                    </div>
                    <div className="mt-6 text-right">
                      <motion.button onClick={() => setSelectedOrg(null)}>
                        Close
                      </motion.button>
                    </div>
                  </motion.div>
